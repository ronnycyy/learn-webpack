/**
 *  查看所有 webpack --xx 这样能配置的命令
 * 
 * 比如 webpack --entry index.js
 */
...
module.exports = function (yargs) {
	yargs
		...
		// 用户输入的各种各样的命令 webpack xxx...
		.options({

			// 我们经常写的 webpack --config webpack.config.js，就是这里定义的
			// 这是 CONFIG_GROUP 里的命令
			config: {
				type: "string",
			...
			// 以后写 webpack.config.js，不知道配置的字段名，就在这里找，哈哈~
			output: {
				alias: "o",
